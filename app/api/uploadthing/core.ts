...
// getUser saves the user details by calling the currentUser method in clerk. As we are taking care of auth using clerk, so we just have to call currentUser() to get access to the current user details.
